...
urlpatterns = [
    ...
    path('edit-user-camp/<int:reg_id>', views.RegisterUserCampaignEditApiView.as_view(), name="user-camp-edit"),
    path('client-member-list/<int:client_id>', views.ClientMamabersListDictAPIView.as_view(), name="ClientMamabersListDictAPIView"),
]