# Generated by Django 2.2.6 on 2024-03-30 05:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('positionId', models.CharField(blank=True, max_length=255, null=True)),
                ('entryPrice', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('closePrice', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('openTimestamp', models.CharField(blank=True, max_length=255, null=True)),
                ('closeTimestamp', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('bookType', models.CharField(blank=True, max_length=255, null=True)),
                ('stake', models.CharField(blank=True, max_length=255, null=True)),
                ('spreadBetting', models.CharField(blank=True, max_length=255, null=True)),
                ('usedMargin', models.CharField(blank=True, max_length=255, null=True)),
                ('trade_type', models.CharField(blank=True, max_length=255, null=True)),
                ('pnl', models.CharField(blank=True, max_length=255, null=True)),
                ('depositConversionRate', models.CharField(blank=True, max_length=255, null=True)),
                ('usdConversionRate', models.CharField(blank=True, max_length=255, null=True)),
                ('dealId', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
                'ordering': ['id'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leverageInCents', models.CharField(blank=True, max_length=120, null=True)),
                ...
                ('accessRights', models.CharField(blank=True, max_length=120, null=True)),
                ('bonus', models.CharField(blank=True, default='', max_length=120, null=True)),
                ('nonWithdrawableBonus', models.CharField(blank=True, max_length=120, null=True)),
